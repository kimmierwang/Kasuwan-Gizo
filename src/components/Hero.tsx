      ...
      <div className="relative z-10 h-full flex items-center">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 w-full">
          <div className="max-w-2xl">
            ...
            <p className="text-sm sm:text-base lg:text-xl text-white/90 mb-6 sm:mb-8 leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
              <Link
                href="/marketplace"
                className="px-6 sm:px-8 py-2 sm:py-3 bg-white text-gray-900 rounded-lg font-semibold hover:bg-gray-100 transition flex items-center justify-center text-sm sm:text-base"
              >
                Market place
              </Link>
              <Link
                href="/signup"
                className="px-6 sm:px-8 py-2 sm:py-3 bg-teal-600 text-white rounded-lg font-semibold hover:bg-teal-700 transition flex items-center justify-center text-sm sm:text-base"
              >
                Sign Up
              </Link>
            </div>
