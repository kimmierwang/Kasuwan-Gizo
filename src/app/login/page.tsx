...
export default function LoginPage() {
  ...
  function onSubmit(e: React.FormEvent) {
    e.preventDefault();
    // Instantly navigate without any backend validation
    ...
    <div className="flex w-full justify-center py-6 sm:py-10 px-4">
      <div className="w-full max-w-md rounded-2xl border border-emerald-200 bg-emerald-50 p-5 sm:p-6 shadow-sm">
        ...
        <form onSubmit={onSubmit}>
          <label className="block text-xs sm:text-sm font-medium text-gray-800">Email</label>
          <input
            type="email"
            value={email}
          ...
          <button
            type="submit"
            className="mt-6 w-full rounded-lg bg-emerald-600 px-4 py-2 sm:py-3 font-semibold text-white text-sm sm:text-base transition hover:bg-emerald-700"
          >
            Login
          </button>
